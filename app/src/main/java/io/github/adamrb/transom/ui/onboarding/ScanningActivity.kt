...
import io.github.adamrb.transom.databinding.ActivityScanningBinding
                    ...
                    deviceManager.connectionState.collect { state ->
                        when (state) {
                            ...
                            is DeviceConnectionState.Failed -> {
                                ...
                                if (state.message == io.github.adamrb.transom.managers.DeviceManager.BLUETOOTH_OFF_MESSAGE) {
                                    stopAnimations()
