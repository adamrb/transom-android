...
import io.github.adamrb.transom.databinding.SheetFirmwareUpdateBinding
import io.github.adamrb.transom.models.FirmwareUpdateUiState
...
class FirmwareUpdateSheet : BottomSheetDialogFragment() {
    ...
    private val deviceManager get() = (requireActivity().application as TransomApp).deviceManager
    ...
    private fun awaitReconnectThenDismiss() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            val reconnected = kotlinx.coroutines.withTimeoutOrNull(60_000) {
                deviceManager.connectionState.first { it is io.github.adamrb.transom.models.DeviceConnectionState.Connected }
            } != null
