package io.github.adamrb.transom
...
import io.github.adamrb.transom.managers.DeviceManager
import io.github.adamrb.transom.managers.DeviceManagerProtocol
import io.github.adamrb.transom.managers.RecordingManager
import io.github.adamrb.transom.managers.RecordingManagerProtocol
import io.github.adamrb.transom.managers.SyncManager
import io.github.adamrb.transom.managers.SyncManagerProtocol
import io.github.adamrb.transom.managers.mock.MockDeviceManager
import io.github.adamrb.transom.managers.mock.MockRecordingManager
import io.github.adamrb.transom.managers.mock.MockSyncManager
...
class TransomApp : Application() {
    ...
    override fun onCreate() {
        ...
        io.github.adamrb.transom.common.AppNotifications.ensureChannels(this)
        ...
        Thread {
            ...
            io.github.adamrb.transom.net.UpdateManager.cleanupStaleApks(
    ...
    private fun registerForegroundReconnect() {
        registerActivityLifecycleCallbacks(object : ActivityLifecycleCallbacksAdapter() {
            ...
            override fun onActivityStarted(activity: android.app.Activity) {
                ...
                io.github.adamrb.transom.managers.UploadManager.kick()
                io.github.adamrb.transom.managers.AutomationWatcher.kick()
