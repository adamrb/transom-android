...
import io.github.adamrb.transom.ui.library.WebViewOriginPolicy
...
object QrLoginApproval {
    ...
    private fun looksLikeSetupCode(raw: String?): Boolean =
        io.github.adamrb.transom.common.QrSetupPayload.parse(raw) is io.github.adamrb.transom.common.QrSetupPayload.Result.Success
}
