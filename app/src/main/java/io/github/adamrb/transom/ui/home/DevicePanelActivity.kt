...
import io.github.adamrb.transom.databinding.ActivityDevicePanelBinding
        ...
        binding.unpairRow.setOnClickListener {
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.confirm) { _, _ ->
                    ...
                    io.github.adamrb.transom.service.DeviceConnectionService.sync(this)
    ...
    private fun bindDevice(name: String, sn: String, firmware: String, latest: String?) {
        ...
        if (latest != null && latest != firmware) {
            ...
            binding.firmwareUpdateButton.setOnClickListener {
                io.github.adamrb.transom.ui.settings.FirmwareUpdateSheet
                    .newInstance(name)
