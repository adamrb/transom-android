...
import io.github.adamrb.transom.databinding.ActivityQrLoginBinding
...
class QrLoginActivity : AppCompatActivity() {
    ...
    companion object {
         ...
         * `adb shell am start -n io.github.adamrb.transom/.ui.settings.QrLoginActivity --es scanned '{...}'`.
    ...
    private fun confirmApproval(payload: io.github.adamrb.transom.common.QrLoginPayload) {
        showStatus("", isError = false)
        AlertDialog.Builder(this)
