...
/**
 * `window.TransomApp`: the two native hooks the embedded dashboard may call.
 *
...
class TransomJsInterface(
    ...
    companion object {
        private const val TAG = "TransomJs"

        /** Name the dashboard looks for: `window.TransomApp`. */
        const val JS_NAME = "TransomApp"
