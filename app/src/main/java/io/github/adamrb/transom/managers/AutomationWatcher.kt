...
import io.github.adamrb.transom.common.AppNotifications
...
import io.github.adamrb.transom.work.AutomationWatchScheduler
...
object AutomationWatcher {
    ...
    internal var notifier: Notifier = object : Notifier {
        private fun context(): Context? = try { TransomApp.instance } catch (e: UninitializedPropertyAccessException) { null }
    ...
    internal var onAnnounced: () -> Unit = {
        scope.launch {
            try {
                io.github.adamrb.transom.ui.recordings.RecordingsRepository.refresh()
            } catch (t: Throwable) {
