...
class DeviceManager private constructor() : DeviceManagerProtocol {
    ...
    private val partnerToken get() = cloud.adamrb.transom.net.TokenManager.currentToken
    ...
    override fun configure(userId: String) {
        ...
        val cached = cloud.adamrb.transom.net.TokenManager.cachedTokenIfValid()
        if (cached != null) {
        ...
        scope.launch(Dispatchers.IO) {
            try {
                val token = cloud.adamrb.transom.net.TokenManager.getValidToken()
    ...
    override fun connect(device: ScannedDevice, userId: String, userInitiated: Boolean) {
        ...
        scope.launch(Dispatchers.IO) {
            try {
                ...
                if (cloud.adamrb.transom.net.TokenManager.cachedTokenIfValid() == null &&
                    cloud.adamrb.transom.net.TokenManager.refreshAndApply() == null
                ) {
                    awaitingHandshake = false
    ...
    private fun cloudBind(sn: String) {
        scope.launch(Dispatchers.IO) {
            ...
            if (code == 401) {
                ...
                if (cloud.adamrb.transom.net.TokenManager.refreshAndApply() != null) {
