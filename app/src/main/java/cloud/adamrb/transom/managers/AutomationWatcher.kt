...
import cloud.adamrb.transom.common.AppNotifications
...
import cloud.adamrb.transom.work.AutomationWatchScheduler
...
object AutomationWatcher {
    ...
    internal var onAnnounced: () -> Unit = {
        scope.launch {
            try {
                cloud.adamrb.transom.ui.recordings.RecordingsRepository.refresh()
            } catch (t: Throwable) {
