...
import cloud.adamrb.transom.common.QrLoginPayload
import cloud.adamrb.transom.common.QrSetupPayload
import cloud.adamrb.transom.common.ServerErrorText
import cloud.adamrb.transom.databinding.ActivityServerSetupBinding
...
class ServerSetupActivity : AppCompatActivity() {
    ...
    private fun testConnection() {
        ...
        lifecycleScope.launch {
            ...
            plaudToken?.let { cloud.adamrb.transom.net.TokenManager.store(it) }
            verified = true
