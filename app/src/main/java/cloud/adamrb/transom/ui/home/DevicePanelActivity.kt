...
import cloud.adamrb.transom.databinding.ActivityDevicePanelBinding
...
class DevicePanelActivity : AppCompatActivity() {
    ...
    private val recordingManager get() = (application as TransomApp).recordingManager
        ...
        binding.unpairRow.setOnClickListener {
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.confirm) { _, _ ->
                    ...
                    cloud.adamrb.transom.service.DeviceConnectionService.sync(this)
    ...
    private fun bindDevice(name: String, sn: String, firmware: String, latest: String?) {
        ...
        if (latest != null && latest != firmware) {
            ...
            binding.firmwareUpdateButton.setOnClickListener {
                cloud.adamrb.transom.ui.settings.FirmwareUpdateSheet
                    .newInstance(name)
