...
import cloud.adamrb.transom.databinding.SheetFirmwareUpdateBinding
    ...
    private fun awaitReconnectThenDismiss() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            val reconnected = kotlinx.coroutines.withTimeoutOrNull(60_000) {
                deviceManager.connectionState.first { it is cloud.adamrb.transom.models.DeviceConnectionState.Connected }
            } != null
