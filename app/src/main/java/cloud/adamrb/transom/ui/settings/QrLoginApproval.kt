...
import cloud.adamrb.transom.ui.library.WebViewOriginPolicy
...
object QrLoginApproval {
    ...
    private fun looksLikeSetupCode(raw: String?): Boolean =
        cloud.adamrb.transom.common.QrSetupPayload.parse(raw) is cloud.adamrb.transom.common.QrSetupPayload.Result.Success
}
