...
import cloud.adamrb.transom.databinding.ActivityQrLoginBinding
...
class QrLoginActivity : AppCompatActivity() {
    ...
    companion object {
         ...
         * `adb shell am start -n cloud.adamrb.transom/.ui.settings.QrLoginActivity --es scanned '{...}'`.
    ...
    private fun confirmApproval(payload: cloud.adamrb.transom.common.QrLoginPayload) {
        showStatus("", isError = false)
        AlertDialog.Builder(this)
