package cloud.adamrb.transom.storage
...
object RecordingStore {
    ...
    /** Settings > Appearance: System (default), Light or Dark; see [cloud.adamrb.transom.common.Appearance]. */
    var appearance: cloud.adamrb.transom.common.Appearance
        get() = cloud.adamrb.transom.common.Appearance.fromStorage(prefs.getString(KEY_APPEARANCE, null))
    ...
    fun markAsSynced(deviceSN: String, sessionId: Long, localPath: String, duration: Long) {
        ...
        if (discard) {
            cloud.adamrb.transom.common.AppLog.i(
    ...
    private fun saveFiles(files: List<RecordingFile>) {
        ...
        if (!tmp.renameTo(target)) {
            ...
            cloud.adamrb.transom.common.AppLog.w(
