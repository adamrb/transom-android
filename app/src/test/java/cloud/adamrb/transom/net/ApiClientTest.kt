...
class ApiClientTest {
    ...
    fun fetchVocabularyGetsEntriesAndEditorText() {
        ...
        assertEquals(
            listOf(
                cloud.adamrb.transom.models.VocabEntry("Parrot Deck", listOf("Parted Deck", "Carrot Deck"), "manual"),
                cloud.adamrb.transom.models.VocabEntry("Morgan", emptyList(), "obsidian")
            ),
            ok.entries
        )
    ...
    fun saveVocabularyPutsEntriesAndRendersEditorTextLocally() {
        ...
        val result = ApiClient.saveVocabulary(
            listOf(
                cloud.adamrb.transom.models.VocabEntry("Parrot Deck", listOf("Parted Deck"), "manual"),
                cloud.adamrb.transom.models.VocabEntry("Morgan", emptyList(), "obsidian")
            )
        )
        assertTrue(result.toString(), result is ApiClient.VocabularyResult.Ok)
    ...
    fun saveVocabulary422IsError() {
        ...
        val result = ApiClient.saveVocabulary(listOf(cloud.adamrb.transom.models.VocabEntry("x".repeat(80))))
